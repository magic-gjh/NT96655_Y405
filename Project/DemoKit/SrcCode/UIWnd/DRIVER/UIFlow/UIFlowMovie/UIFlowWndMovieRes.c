...
SHOW_ITEM_GROUP(CMD_Group,Normal44,227,5,312,34)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_time,0,227,5,312,34)
...
SHOW_ITEM_GROUP(CMD_Group,Normal49,227,5,312,34)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_Static_maxtime,0,227,5,312,34)
...
SHOW_ITEM_GROUP(CMD_Group,Normal89,280,72,307,99)
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_GPS,0,280,72,307,99)
...
SHOW_ITEM_GROUP(CMD_Group,Normal94,280,143,307,170)
...
SHOW_ITEM_GROUP(CMD_Group,Normal99,280,110,307,137)
...
SHOW_ITEM_GROUP(CMD_Group,Normal125,12,103,39,130)

CREATE_STATE_ITEM_DATA(ICONID_NULL128,STRID_NULL,ICON_MOVIE_PARKING_OFF,NULL) 
CREATE_STATE_ITEM_DATA(ICON_PARKING_MONITOR129,STRID_NULL,ICON_MOVIE_PARKING_ON,NULL) 
...
CREATE_STATE_CTRL(UIFlowWndMovie_Status_ParkingMonitor,0,12,103,39,130)
...
SHOW_ITEM_GROUP(CMD_Group,Normal130,86,188,255,207)
...
SHOW_ITEM_GROUP(CMD_Group,Normal135,65,187,85,211)
...
SHOW_ITEM_GROUP(CMD_Group,Skin145,0,0,319,239)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon146, 6, 6, 21,21, ICONID_NULL,83886080,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal144)
SHOW_MAP_BODY(Skin145)
SHOW_MAP_BODY(Icon146)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal144,0,0,319,239)

SHOW_MAP_BEGIN(UIFlowWndMovie_daoche)
SHOW_MAP_BODY(Normal144)
SHOW_MAP_END

DECLARE_EVENT(UIFlowWndMovie_daoche)
CREATE_STATIC_DATA(UIFlowWndMovie_daoche,DAOCHE)
CREATE_STATIC_CTRL(UIFlowWndMovie_daoche,0,0,0,319,239)
*/
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Normal122,56,156,255,183)
...
CREATE_STATIC_CTRL(UIFlowWndMovie_StaticTXT_Speed,0,56,156,255,183)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
