...
#define KEY_BOARD_TYPE   PW84_KEY_BOARD_AIDUOSHI_6KEYS// PW84_KEY_BOARD_AIDUOSHI_6KEYS//
...
#define VOLDET_KEY_ADC_TH           (514+VOLDET_KEY_ADC_RANGE)
#elif(KEY_BOARD_TYPE==PW84_KEY_BOARD_AIDUOSHI_6KEYS)
#define VOLDET_KEY_ADC_RANGE        (25)
#define VOLDET_KEY_ADC_LVL0         (0)
#define VOLDET_KEY_ADC_LVL1         (189-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2         (365-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (571-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (750-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL5         (890-VOLDET_KEY_ADC_RANGE)
   ...
   //if (uiKey1ADC <1000)
    ...
    if (uiKey1ADC < VOLDET_KEY_ADC_TH)
    {
        ...
        if (uiKey1ADC >= VOLDET_KEY_ADC_LVL5)
               {
                   uiCurKey2Lvl = VOLDET_KEY_LVL_UP;//VOLDET_KEY_LVL_DOWN;
               }  
        ...
        {
            uiCurKey2Lvl = VOLDET_KEY_LVL_DOWN;//VOLDET_KEY_LVL_UP;
        }    
        else if (uiKey1ADC >= VOLDET_KEY_ADC_LVL2)
        {
            uiCurKey2Lvl = VOLDET_KEY_LVL_REC;//VOLDET_KEY_LVL_UNKNOWN;//VOLDET_KEY_LVL_DOWN;
        }
        else if (uiKey1ADC >= VOLDET_KEY_ADC_LVL1)
        {
            uiCurKey2Lvl = VOLDET_KEY_LVL_MODE;//VOLDET_KEY_LVL_MENU;
        }
        else if (uiKey1ADC >= VOLDET_KEY_ADC_LVL0)
        {
...
UINT32 DrvKey_DetNormalKey(void)
{
    ...
    if (VolDet_GetKey1Level() == VOLDET_KEY_LVL_REC)
    {
